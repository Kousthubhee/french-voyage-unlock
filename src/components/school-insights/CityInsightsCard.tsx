...
import { Info, Transport, Landmark, SportsFacilities, StudentLife } from "lucide-react";
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <Transport className="h-5 w-5 mr-2 text-blue-600" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <SportsFacilities className="h-5 w-5 mr-2 text-green-700" />
          ...
          <div className="bg-gray-50 p-4 rounded-lg">
            <div className="flex items-center mb-2">
              <StudentLife className="h-5 w-5 mr-2 text-teal-600" />
